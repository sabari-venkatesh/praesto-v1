...
var _usAll = __webpack_require__(18);
...
var _datatables = __webpack_require__(13);
...
//  var toggle = $('.datas1 .handle');
//  toggle.text(toggle.attr('data-on'));
//
//  $('.datas1 input').change(function () {
...
//  });
//
//  var toggle1 = $('.datas2 .handle');
//  toggle1.text(toggle1.attr('data-on'));
//
//  $('.datas2 input').change(function () {
//    if (!toggle1.prev().is(':checked')) {
//      toggle1.text(toggle1.attr('data-off'));
//    } else {
//      toggle1.text(toggle1.attr('data-on'));
//    }
//  });
