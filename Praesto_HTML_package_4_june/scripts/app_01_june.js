...
var _devbridgeAutocomplete = __webpack_require__(142);

var _devbridgeAutocomplete2 = _interopRequireDefault(_devbridgeAutocomplete);

var _datatables = __webpack_require__(143);
...
var _highcharts = __webpack_require__(146);

var _highcharts2 = _interopRequireDefault(_highcharts);

var _highmaps = __webpack_require__(147);

var _highmaps2 = _interopRequireDefault(_highmaps);

var _usAll = __webpack_require__(148);
...
$(document).ready(function () {
	...
	if ($('#chart-advertising1').length > 0) {
		_highcharts2.default.chart('chart-advertising1', {
			...
			series: [{
				...
				type: 'column',
				yAxis: 1,
				data: [602, 706, 810, 902, 975, 1005]
			}, {
				name: 'Impressions',
				//        type: 'spline',
				color: '#4472C4',
				data: [20360, 22680, 30670, 32011, 33457, 33610]
			}, {
				name: 'Clicks',
				color: '#1b66aa',
				//        type: 'spline',
				yAxis: 1,
				data: [168, 202, 304, 386, 418, 463]
			}, {
				name: 'CPC',
				color: '#25aa1b',
				//        type: 'spline',
				yAxis: 1,
				data: [0.09, 0.10, 0.16, 0.18, 0.45, 1.02]
			}, {
				name: 'ACOS',
				color: '#7cb5ec',
				//        type: 'spline',
	...
	if ($('#chart-advertising2').length > 0) {
		_highcharts2.default.chart('chart-advertising2', {
			...
			series: [{
				...
				type: 'column',
				yAxis: 1,
				data: [780, 812, 975, 1077, 1181, 1268]
			}, {
				name: 'Impressions',
				//        type: 'spline',
				color: '#4472C4',
				data: [20360, 22680, 28670, 32011, 33457, 33610]
			}, {
				name: 'Clicks',
				color: '#1b66aa',
				//        type: 'spline',
				yAxis: 1,
				data: [162, 223, 315, 393, 472, 576]
			}, {
				name: 'CPC',
				color: '#25aa1b',
				//        type: 'spline',
				yAxis: 1,
				data: [0.11, 0.12, 0.15, 0.18, 0.73, 1.02]
			}, {
				name: 'ACOS',
				color: '#7cb5ec',
				//        type: 'spline',
	...
	if ($('#chart-advertising3').length > 0) {
		_highcharts2.default.chart('chart-advertising3', {
			...
			series: [{
				...
				type: 'column',
				yAxis: 1,
				data: [787, 863, 925, 1011, 1198, 1295]
			}, {
				name: 'Impressions',
				//        type: 'spline',
				color: '#4472C4',
				data: [25360, 27680, 28670, 32011, 33457, 33610]
			}, {
				name: 'Clicks',
				color: '#1b66aa',
				//        type: 'spline',
				yAxis: 1,
				data: [167, 228, 319, 397, 476, 578]
			}, {
				name: 'CPC',
				color: '#25aa1b',
				//        type: 'spline',
	...
	if ($('#chart-aap-advertising').length > 0) {
		_highcharts2.default.chart('chart-aap-advertising', {
			...
			xAxis: [{
				categories: ['06 May', '08 May', '10 May', '12 May', '14 May', '16 May', '18 May', '20 May', '22 May', '24 May', '26 May'],
				crosshair: true
			}],
			yAxis: [{ // Primary yAxis
				labels: {
			...
			series: [{
				...
				color: '#1b66aa',
				yAxis: 1,
				data: [2570, 3926,4778,4890, 5356, 6900, 7800,8400, 8752, 9865, 10542]
			}, {
				name: 'CTR',
				type: 'spline',
				color: '#25aa1b',
				data: [0.21, 0.45, 0.15, 2.15, 1.65, 1.78, 2.8, 2.7, 3.2, 3.4, 4.4]
			}, {
				name: 'Impressions',
				type: 'spline',
				data: [1756, 1587, 2035, 2412, 2898, 3865, 5225, 6247, 7087, 8065, 9045]
			}]
		});
	}
	...
	if ($('#chart-reviews').length > 0) {
		_highcharts2.default.chart('chart-reviews', {
			...
			series: [{
				...
				color: '#7cb5ec',
				data: [90, 100, 95, 90, 80, 105, 108]
			}, {
				name: 'Total Reviews Year to Date',
				color: '#dfe1e2',
				data: [70, 65, 45, 78, 75, 70, 79]
			}]
		});
	}
	/* Reviews: Pie chart */
	...
	if ($('#chart-forecast').length > 0) {
		_highcharts2.default.chart('chart-forecast', {
			...
			series: [{
				name: 'Ordered Units',
				data: [0, 180, 980, 1158, 1658, 2487, 3285, 4985, 5274, 6785, 7455, 8012, 9754],
				pointStart: Date.UTC(2018, 0, 29),
				pointInterval: 24 * 3600 * 1000 * 7 // one week
			}, {
				name: 'Mean Forecast',
				data: [0, 168, 1100, 2253, 2685, 3548, 4568, 7854, 8652, 9050, 10578, 11745, 12895],
				...
				name: 'Amazom on hand',
				data: [0, 659, 479, 1076, 2587, 3144, 966, 889, 2027, 568, 763, 589, 810],
				pointStart: Date.UTC(2018, 0, 28),
				pointInterval: 24 * 3600 * 1000 * 7, // one week
                                type: 'column'
			}, {
				name: 'Open PO',
				data: [0, 4, 156, 785, 768, 309, 351, 1103, 738, 663, 131, 572, 756],
				pointStart: Date.UTC(2018, 0, 28),
				pointInterval: 24 * 3600 * 1000 * 7 // one week
			}],
